...
<div id="container-user-akses">
    ...
    <form action="<?php echo BASE_URL."proses_register.php"; ?>" method="POST">
        ...
        if($notif == "require"){
            ...
            echo "<div class='notif'>Maaf, Password yang kamu masukan tidak sesuai</div>"; 
        }else if($notif == "email"){
        ...
        <div class="element-form">
            ...
            <span><input type="password" name="password"></input></span>
        </div>

        <div class="element-form">
            <label>Re-type Password</label>
            <span><input type="password" name="re_password"></input></span>
        </div>
